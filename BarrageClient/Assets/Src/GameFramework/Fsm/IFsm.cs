...
namespace GameFramework.Fsm
{
    ...
    public interface IFsm<T> where T : class
    {
        ...
        /// <returns></returns>
        TState RemoveFsmState<TState>() where TState : FsmState<T>;
        ...
        /// <typeparam name="TState"></typeparam>
        /// <returns></returns>
        bool IsInState<TState>() where TState : FsmState<T>;



       TState CreateFsmState<TState>(TState fsmstate) where TState : FsmState<T>;
        /// <summary>
        /// 开始有限状态机。
        /// </summary>
