    ...
    public static class FileHelper
    {
        ...
        public static void RecursionFileExecute(string path, string expandName, FileExecuteHandle handle)
        {
            ...
            foreach (var item in allUIPrefabName)
            {
                ...
                {
                    Log.Error("RecursionFileExecute Error :" + item + " Exception:" + e.ToString());
                }
            }
        ...
        public static string ReadStringByFile(string path)
        {
            ...
            try
            {
                if (!File.Exists(path))
                {
                    Log.Debug("path dont exists ! : " + path);
                    return "";
                }
            ...
            {
                Log.Debug("Load text fail ! message:" + e.Message);
            }
        ...
        public static void DeleteFile(string path)
        {
            ...
            {
                Log.Debug("File:[" + path + "] dont exists");
            }
        }
        ...
        public static byte[] GetDataFromFile(string path)
        {
            ...
            {
                Log.Error("GetDataFromFile" + ex.ToString());
            }
            return null;
        }
        public static void SaveDataToFile(string path, byte[] bys)
        {
            ...
            {
                Log.Error("SaveDataToFile error" + ex.ToString());
            }
