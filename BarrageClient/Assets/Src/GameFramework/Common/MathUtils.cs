...
namespace GameFramework
{
    ...
    public static class MathUtils
    {
        ...
        /// 范围反射
        /// </summary>
        /// <param name="fdata">参数</param>
        /// <param name="real1">原始范围0</param>
        /// <param name="real2">原始范围1</param>
        /// <param name="dest1">反射后范围0</param>
        /// <param name="dest2">反射后范围1</param>
        /// <returns></returns>
        public static float ReMap_F(float fdata ,float real1,float real2,float dest1,float dest2)
        {
            if (fdata<real1)
            {
                return dest1;
            ...
            return (dest2 - dest1) * fdata / (real2 - real1) + dest1;
